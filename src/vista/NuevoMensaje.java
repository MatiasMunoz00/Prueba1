...
public class NuevoMensaje extends javax.swing.JFrame {
    ...
    private void enviarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enviarButtonActionPerformed
     String msj = cuerpoMensajeTA.getText();
      MensajeDao mdao = new MensajeDao();
        Usuario emisor = new Usuario(WAIT_CURSOR, msj);
        Usuario receptor = new Usuario(WAIT_CURSOR, msj);
      Mensaje men = new Mensaje(emisor, receptor, msj);
      mdao.insertarMensaje(men);
