...
public class Login extends javax.swing.JFrame {
    ...
    private void entrarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_entrarButtonActionPerformed
        ...
        ArrayList<Usuario> user = ud.getUsuarios();
        
        for (int i = 0; i < user.size(); i++) {
            if (nombre.equalsIgnoreCase(user.get(i).getNombre())) {
                id = user.get(i).getId_usuario();
              BandejaEntrada be = new BandejaEntrada(id);
              be.setVisible(true);
            }else{
                JOptionPane.showInputDialog(null,"No se encuentra el usuario requerido");
            }
        }
